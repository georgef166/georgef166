...
## Featured Projects
- 🦎 A11Yson — A11Yson is an AI-powered cognitive accessibility platform designed to make the web neuro-inclusive — https://github.com/georgef166/A11Yson
- 💻 ParagonAI | The Null Pointers — CLI tool that lets you create, configure, and deploy GenAI agents directly from your terminal. - https://github.com/georgef166/ParagonAI-The-Null-Pointers
- 📍 SideQuest — Personalized discovery platform that transforms local exploration into interactive "quests" by generating curated, multi-step sequences of activities and places based on your current location, mood, and budget. — https://github.com/georgef166/SideQuest
